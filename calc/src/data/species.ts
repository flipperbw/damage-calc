...
const CHAMPIONS_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  // The vendored species table carries Legends Z-A ability assignments for
  // these formes; Champions gives them different abilities. Sourced from
  // smogon/pokemon-showdown data/pokedex.ts @ 524413e84 (Regulation M-C),
  // cross-checked against op.gg's Champions pokedex.
  'Absol-Mega-Z': {abilities: {0: 'Sharpness'}},
  'Garchomp-Mega-Z': {abilities: {0: 'Levitate'}},
  'Golisopod-Mega': {abilities: {0: 'Tough Claws'}},
  'Lucario-Mega-Z': {abilities: {0: 'Aura Guard'}},
};
